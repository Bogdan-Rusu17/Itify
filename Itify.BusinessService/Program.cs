...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.AddServer(new Microsoft.OpenApi.Models.OpenApiServer { Url = "/api" });
...
app.UseSwagger();
app.UseSwaggerUI(c => c.SwaggerEndpoint("/api/swagger/v1/swagger.json", "Itify Business Service v1"));

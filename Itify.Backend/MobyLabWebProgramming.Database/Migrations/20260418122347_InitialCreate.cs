        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Device_SerialNumber", x => x.SerialNumber);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceRequest_DeviceCategory_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "DeviceCategory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeviceRequest_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceAssignment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeviceAssignment_Device_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Device",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeviceAssignment_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ticket_DeviceAssignment_DeviceAssignmentId",
                        column: x => x.DeviceAssignmentId,
                        principalTable: "DeviceAssignment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceAssignment_DeviceId",
                table: "DeviceAssignment",
                column: "DeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceAssignment_UserId",
                table: "DeviceAssignment",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceRequest_CategoryId",
                table: "DeviceRequest",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceRequest_UserId",
                table: "DeviceRequest",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Ticket_DeviceAssignmentId",
                table: "Ticket",
